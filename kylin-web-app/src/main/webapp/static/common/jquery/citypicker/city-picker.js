    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span txt" style="' +
                    'height:' + p.height + 'px;line-height:' + (p.height - 1) + 'px;">' +
                    '<input placeholder='+placeholder+' class="title valid">' +
                    '<div class="arrow"></div></span>',
                    /*(placeholder ? '<span contenteditable class="placeholder">' + placeholder + '</span>' : '') +
                    '<span contenteditable class="title"></span><div class="arrow"></div>' + '</span>',*/
        ...
        feedText: function () {
            ...
            var elemValue = this.$element.val();
            if (text) {
                /*this.$textspan.find('>.placeholder').hide();*/
                this.$textspan.find('>.title').val(this.getText()).show();
            } else {
                this.$textspan.find('>.title').val(elemValue).show();
               /* this.$textspan.find('>.title').val('').hide();*/
            }
        },
