	...
	scope.Configuration = function Configuration(options) {
		var defaults = {
			...
			list: {
				...
				/* Events */
				onClickEvent: function(field) {},
				onSelectItemEvent: function(field) {},
				onLoadEvent: function(field) {},
				onChooseEvent: function(field) {},
				onKeyEnterEvent: function(field) {},
				onMouseOverEvent: function(onMouseOverEvent) {},
				onMouseOutEvent: function() {},	
				onShowListEvent: function(field) {},
				onHideListEvent: function(field) {}
			},
			...
			function createContainer() {
				...
				(function() {
					$elements_container.on("show.eac", function() {
							...
							config.get("list").onSelectItemEvent($field, $this);
