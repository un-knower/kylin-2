...
<head>
    ...
    <style>
		.printBox{margin:-14mm auto 0;}
		.printBox .printUl{margin-top:-0.3mm;}
		.printUl{width:70mm;height:85mm;} 
		.printUl li:nth-child(1){margin-top:5mm;} 
		.dataBox{display:flex;display:-webkit-flex;align-items:center;height:40px;}
		.barCodeNum{height:30px;line-height:30px;}
		.barcode {height:1in;}
		.barcode div {height: 0.82in; /*size*/}
    </style>
</head>
<body>
<div id='rrapp' v-cloak>
        <div  class='list-top'>
			<h2 class='head-middle head-tag title send-title'><span style="font-size:25px !important">客户标签</span></h2>
		...
		<div class="printBox" style="display:none;">
			<ul class="printUl" v-for="(v,k) in circulJianShu">
	              <li class="dataBox">
	                   <div class="labelTime" style="height:33px;"><span>{{sysTime}}</span></div>
