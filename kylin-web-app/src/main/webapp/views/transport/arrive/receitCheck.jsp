...
<!--  
		...
		<div class='layui-form-item' style='max-width: 1400px;'>
			...
			<div class='layui-inline'>
				<div class='input-div'>
					...
					<div class='layui-input-block'>
						<input v-model='checkinfo.thqshdid' type='text' id='TihuoId' class='layui-input'>
					</div>
				</div>
			</div>
			<div class='layui-inline'>
    ...
    <table class='layui-hide' id='tableList' lay-filter='table-data'></table>
     <script type="text/html" id="pickSignBill">
  		<a class="layui-btn layui-btn-warn layui-btn-xs" style="line-height:20px;" lay-event="createpick">查看</a>
	</script>
    <div class='receive-bill' v-show='false'>
		<receipt-bill ref='tihuoSign' :username='username' :curr_time='currTime' :xuhaos='tihuoListXuhao' :tablelist='tihuoListData'></receipt-bill>
	</div>
    ...
    <script src="${ctx_static}/transport/arrivalsendSignCheck/js/receitCheck.js?t=3"></script>
</body>
</html>