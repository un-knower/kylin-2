...
<div id='newpicktohome'>
   ...
   <div class='print-page'>
					...
					<tbody>
						...
						<tr>
						    ...
						    <td colspan="3" rowspan="2">
 						    	<input type="checkbox" id="songhuoshanglou" value="1" lay-ignore name="songhuoshanglou" class="orderEntity"/>送货上楼
						    	<input type="checkbox" id="daikezhuangxie" value="1" lay-ignore name="daikezhuangxie" class="orderEntity"/>代客装卸
						    </td>
						</tr>
						<tr>
						    <td colspan="7">
			...
			<div style="text-align:center;margin-top:20px;margin-bottom: 30px;">
			    <button onclick="savePickFormHomeOrder()" class="layui-btn" type='button'>保存</button>
			    <!-- 
