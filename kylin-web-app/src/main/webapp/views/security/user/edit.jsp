...
<legend class="nav-title">
	<ol class="breadcrumb">
	  <li>权限管理</li><li>用户管理</li><li>编辑用户</li><a href="javascript:history.back();" class="pull-right">返回</a>
	</ol>
</legend>
<form class="form-horizontal" role="form" action="${base_url}/security/user/edit/save" method="post">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="userId" name="user.account" placeholder="请输入工号" value="${userModel.account}" readonly="readonly">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="company" name="user.company" placeholder="请输入姓名" value="${userModel.company}">
					</div>
				</div>
				<div class="form-group">
					<label for="subCompany" class="col-sm-2 control-label">分公司</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="subCompany" name="user.subCompany" placeholder="请输入姓名" value="${userModel.subCompany}">
					</div>
				</div>
				<div class="form-group">
						...
						<div class="radio">
						   <c:choose>
								<c:when test="${userModel.enable == 0 || userModel.enable == 2}">
								   <label>
							   	  		<input type="radio" name="enable" id="radio_enable_1" value="1" readonly>启用状态
								   </label>
								   <label>
								      	<input type="radio" name="enable" id="radio_enable_2" value="2" checked readonly>禁用状态
								   </label>
								</c:when>
								<c:otherwise>
								   <label>
							   	  		<input type="radio" name="enable" id="radio_enable_1" value="1" checked readonly>启用状态
								   </label>
								   <label>
								      	<input type="radio" name="enable" id="radio_enable_2" value="2" readonly>禁用状态
								   </label>
								</c:otherwise>
							</c:choose>
						</div>
