...
<legend class="nav-title">
	<ol class="breadcrumb">
	  <li>权限管理</li><li>资源管理</li><li>编辑资源</li><a href="javascript:history.back();" class="pull-right">返回</a>
	</ol>
</legend>
<form class="form-horizontal" role="form" action="${base_url}/security/res/edit/save" method="post">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<div class="col-sm-offset-9 col-sm-2">
						<input type="hidden" name="res.resourceId" value="${resModel.resourceId}">
